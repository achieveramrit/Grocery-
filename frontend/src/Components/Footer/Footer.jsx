...
const Footer = () => {
  ...
  const sendMessage = () => {
    window.location = `https://wa.me/8511962301?text=${message}`;
  };
  return (
    <>
      <footer>
        <section className="footer">
          <div className="box-container">
            <div className="box">
              ...
              <div className="share">
                <Link>
                  <i
                    onClick={() => {
                      window.location = `https://wa.me/8511962301?text=Say Hello..!!`;
                    }}
                  >
                    {<IoLogoWhatsapp />}
                  </i>
                ...
                <a href="https://www.linkedin.com/in/amrit-singh-606150311?trk=people-guest_people_search-card">
            ...
            <div className="box">
              ...
              <a href="mailto:amritkumarsingh3251@gmail.com" className="links">
                <i>
                  <MdOutlineMarkEmailRead />
                </i>
                amritkumarsingh3251@gmail.com
              </a>
          ...
          <div className="credit">
            Prepared by <span>Amrit Singh </span> | All Right Reserved
          </div>
        </section>
      </footer>
    </>
